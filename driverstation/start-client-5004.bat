...
:: This can be used to start listening to a GStreamer UDP feed on port 5004
:: For convenience, creating a shortcut on the desktop to this script is recommended

gst-launch-1.0 udpsrc port=5004 ! "application/x-rtp" ! rtph264depay ! avdec_h264 ! videoflip method=clockwise ! videoflip method=clockwise ! autovideosink
