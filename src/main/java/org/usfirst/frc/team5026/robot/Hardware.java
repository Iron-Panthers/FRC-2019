...
public class Hardware {
	...
	public Hardware() {
		...
		rightDriveMotors = new SparkMaxMotorGroup("Right Drive Motor Group", driveRight2, driveRight2);
		leftDriveMotors = new SparkMaxMotorGroup("Left Drive Motor Group", driveLeft2, driveLeft2);

		rightDriveMotors.setInverted(Constants.Drivebase.IS_RIGHT_INVERTED);
		leftDriveMotors.setInverted(Constants.Drivebase.IS_LEFT_INVERTED);
