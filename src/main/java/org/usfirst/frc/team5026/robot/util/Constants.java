...
public class Constants {
    ...
    public class IntakeArm { //TODO Calibrate/Set Ports and Numbers
        ...
        public static final double ARM_BASE_HEIGHT = 1; //in
        public static final double CARGO_SHIP_HEIGHT = 1 - ARM_BASE_HEIGHT; //in
        ...
        public static final double INTAKE_ARM_MASS = 0; //lbs
        ...
        public static final double INTAKE_ARM_MOTOR_MAX_TORQUE = 0;
